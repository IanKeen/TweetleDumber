...
// Generated by Apple Swift version 5.1 effective-4.2 (swiftlang-1100.0.43.3 clang-1100.0.26.3)
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MustardKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10MustardKit25CollectionViewCoordinator")
@interface CollectionViewCoordinator : NSObject <UICollectionViewDataSource, UICollectionViewDelegate>
...
SWIFT_CLASS("_TtC10MustardKit9FadeSegue")
...
SWIFT_CLASS("_TtC10MustardKit13FadePushSegue")
@interface FadePushSegue : FadeSegue
- (nonnull instancetype)initWithIdentifier:(NSString * _Nullable)identifier source:(UIViewController * _Nonnull)source destination:(UIViewController * _Nonnull)destination OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC10MustardKit14FadeResetSegue")
@interface FadeResetSegue : FadeSegue
- (nonnull instancetype)initWithIdentifier:(NSString * _Nullable)identifier source:(UIViewController * _Nonnull)source destination:(UIViewController * _Nonnull)destination OBJC_DESIGNATED_INITIALIZER;
@end
...
/// A <code>UIView</code> whose background cannot be clear
/// Useful for subviews within cells, makes it so selection doesn’t interfere with the appearance
SWIFT_CLASS("_TtC10MustardKit14NeverClearView")
...
SWIFT_CLASS("_TtC10MustardKit15NibReusableView")
@interface NibReusableView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
...
/// Useful as a base class for views that are on top of other views
/// but should not block touch events getting through
SWIFT_CLASS("_TtC10MustardKit15PassthroughView")
...
SWIFT_CLASS("_TtC10MustardKit12ResponderBox")
@interface ResponderBox : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC10MustardKit10RibbonView")
@interface RibbonView : UIView
@property (nonatomic, strong) UIColor * _Nonnull ribbonColor;
@property (nonatomic) CGFloat ribbonIndent;
...
SWIFT_CLASS("_TtC10MustardKit10ScrollView")
...
SWIFT_CLASS("_TtC10MustardKit27ServicesApplicationDelegate")
@interface ServicesApplicationDelegate : UIResponder <UIApplicationDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC10MustardKit28SideModalInteractiveAnimator")
@interface SideModalInteractiveAnimator : UIPercentDrivenInteractiveTransition
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC10MustardKit30SideModalTransitioningDelegate")
@interface SideModalTransitioningDelegate : NSObject <UIViewControllerTransitioningDelegate>
...
SWIFT_CLASS("_TtC10MustardKit20TableViewCoordinator")
@interface TableViewCoordinator : NSObject <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC10MustardKit8TextView")
...
@interface UIButton (SWIFT_EXTENSION(MustardKit))
@property (nonatomic, copy) NSString * _Nullable localizationTitleKey;
@end
...
@interface UILabel (SWIFT_EXTENSION(MustardKit))
@property (nonatomic, copy) NSString * _Nullable localizationTextKey;
@end
...
@interface UITextField (SWIFT_EXTENSION(MustardKit))
@property (nonatomic, copy) NSString * _Nullable localizationTextKey;
@property (nonatomic, copy) NSString * _Nullable localizationPlaceholderKey;
@end
...
@interface UIView (SWIFT_EXTENSION(MustardKit))
@property (nonatomic, strong) IBOutlet NSLayoutConstraint * _Nullable keyboardConstraint;
@end
...
SWIFT_CLASS("_TtC10MustardKit19UnitTestAppDelegate")
@interface UnitTestAppDelegate : UIResponder <UIApplicationDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
